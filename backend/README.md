...
## Project Structure
    ...
    ├── testapiautostoryboa_77169  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_77169`
...
2. Clone this repo and `cd testapiautostoryboa_77169`
